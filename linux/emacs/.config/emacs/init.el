...
(tool-bar-mode -1)               ; disbable the toolbar
;;(tool-tip-mode -1)               ; disable tooltips
(set-fringe-mode 0)             ; Give some breathing room
(menu-bar-mode -1)               ; Disable the memubar
...
(set-face-attribute 'default nil :height 100)  ;; Increase font size (default is ~100)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(hydra evil-collection evil general helpful counsel ivy-rich which-key rainbow-delimiters doom-themes doom-modeline ivy)))
(custom-set-faces
